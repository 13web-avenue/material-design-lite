...
test('defaultAdapter returns a complete adapter implementation', t => {
  ...
  t.deepEqual(methods, [
    ...
    'registerAnimationEndHandler', 'deregisterAnimationEndHandler', 'updateDrawerPosition', 'updateComponentBackground',
    'getFocusableElements', 'saveElementTabState', 'restoreElementTabState', 'makeElementUntabbable', 'isRightSide'
  ]);
